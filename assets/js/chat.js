...
// When Phoenix reports a change in Presence status, determine the differences and report the changes to the user
const handlePresenceDiff = diff => {
  ...
  // Finally, display messages for ach person that leaves the chat too!
...
// When Phoenix repots the initial state of Presence status, sync up the list of users
