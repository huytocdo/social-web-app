defmodule Vocial.AccountsTest do
  ...
  describe "users" do
    ...
    def user_fixture(attrs \\ %{}) do
      ...
      do
        #We added a Map.merge call that sets password and password_confirmation to nil! We need to do this, because remember that those two fields are virtual fields; this means they will not receive a value when you select them out of the database!
